    ...
    public class Initialiser : DropCreateDatabaseAlways<CommissionContext>
    {
        ...
        protected override void Seed(CommissionContext db)
        {
            try
            {
                ...
                db.Faculties.Add(new Faculty { FacultyId = 3, Name = "Faculty of Technology", Details = "The Faculty of Technology is the oldest one.", Vacancies = 42, ScholarshipVacancies = 25 });
